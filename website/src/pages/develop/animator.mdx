...
import { AnimatorRef, AnimatorClassSettings, withAnimator } from '@arwes/animator'
...
;<AnimatorGeneralProvider animator={animatorGeneralSettings}>{/* ... */}</AnimatorGeneralProvider>
