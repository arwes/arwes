...
const App: FC = ({ children }) => (
  <BleepsProvider audioSettings={audioSettings}>{children}</BleepsProvider>
)
```
...
const App: FC = ({ children }) => (
  <BleepsProvider playersSettings={playersSettings}>{children}</BleepsProvider>
)
```
...
const App: FC = ({ children }) => (
  <BleepsProvider bleepsSettings={bleepsSettings}>{children}</BleepsProvider>
)
```
